...
class up(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.up = nn.ConvTranspose2d(
            in_channels=in_ch, out_channels=in_ch, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.conv = double_conv(in_ch, out_ch)
...
def _test():
    ...
    print('binary output shape:', target_raw.shape,
          output_raw.shape)  # map_x.shape
